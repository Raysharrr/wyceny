...
export type ProvenanceSource =
  ...
  | "rzeczoznawca"
  | "preset"
  // Prose generated by a language model from this valuation's own facts
  // (ADR-014). Like every other non-human source it can only arrive as
  // "to_verify" — the web-side ACL still owns `status`.
  | "ai";
