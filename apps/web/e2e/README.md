...
| CL-13 | zatwierdzenie i DOCX (§8.2 obie tabele działów, werdykt tylko w podglądzie) | `gluszyna.spec.ts` — „CL-13…” (podgląd PDF + wydany DOCX czytany z `word/document.xml`), w obu T7 raz po protokole gruntu i przed jego tabelą (ADR-024); kontrola UKŁADU tabel w Wordzie zostaje przy rzeczoznawcy                                                                                                                                                                        |
