...
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cztery pełne ścieżki — AC01/03/04/08/09/11 | Zapis/reload własnej cechy, skale mieszane i wagi40,25/59,75; sześć ręcznych sekcji w PDF; §10 PDF: trzy definicje metod, zdanie „zastosowano … metodę <użyta>” i procedura tylko użytej metody; krok 7 bez blokad: brak karty „Zatwierdzenie”, przycisk aktywny; approve→sign z tym samym tekstem; syntetyczny obraz w DOCX; SHA ponownie pobranego podpisanego PDF bez zmian; oryginalny zatwierdzony PDF pozostaje bajtowo identyczny w magazynie; brak przycisków edycji/podpisu. Tylko PP×spółdzielcze: „Utwórz nową wersję” otwiera krok 5 „Kalkulacja niedostępna” z pozycją „Wybierz i potwierdź metodę wyceny.” i odnośnikiem do kroku 3; ponowne potwierdzenie metody, próby, ocen, kalkulacji i opisów („do weryfikacji” ×6) → zatwierdzenie z tym samym WR. |     |
| Metoda/próba — AC01/02/05                  | Wybór bez potwierdzenia nie przetrwa reloadu; KCS11 blokuje („Aby wyliczyć wartość rynkową, uzupełnij:”)/12 daje477500; zmiana metody zeruje WR; PP2 zapisuje tylko pulę, PP3/5 są jawne, szóste porównanie zablokowane; reorder zachowuje oceny przy tożsamościach; PP→KCS zachowuje pełne ceny/pulę.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Cechy/poprawki — AC03/04/06/09             | Kolizja nazwy, błędne wagi, brak oceny, usunięcie średniej oceny po3→2, uzasadnienie−1,25, brak potwierdzenia Enterem w polu, jawne potwierdzenie klawiaturą, konflikt starszej karty, zmiana poprawki przy niezmienionym WR i zachowanie sześciu tekstów; nieaktualne uzasadnienie ma komunikat „Dane wyceny zmieniły się po napisaniu tego opisu” i plakietkę „do weryfikacji”, a krok 7 pokazuje kartę „Zatwierdzenie” z tą blokadą i nieaktywnym przyciskiem.                                                                                                                                                                                                                                                                                                       |
| PP4/Pomoc — AC08/12                        | Rzeczywisty PDF z czterema kolumnami i457500; pełne ścieżki mają także PP3/455000 i PP5/460000. Powierzchnia przedmiotu startuje bez oceny z sugestią „Przyjmij sugerowaną ocenę przedmiotu” (niezapisana do czasu zapisu); bez oceny przy wadze 0 nie blokuje podglądu kwoty ani zapisu. Pomoc kontekstowa kroku3/4 opisuje te same ograniczenia i kontrolki.                                                                                                                                                                                                                                                                                                                                                                                                          |
