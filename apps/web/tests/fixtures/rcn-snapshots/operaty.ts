...
export const OPERATY: Operat[] = [
  ...
  {
    slug: "winiary",
    uugAddress: "Poznań, Os. Winiary 33",
    displayAddress: "Poznań, Os. Winiary 33/3",
    valuationDate: "2026-08-06",
    todayMonth: "2026-08",
    area: 65.6,
    pdfWrUnrounded: 652_642.59,
    pdfWrRounded: 652_600,
    pdfCsr: 9840.57,
    features: [
      f("standard_wykonczenia", 0.3, "gorsza"),
      f("powierzchnia", 0.25, "przecietna"),
      f("pietro", 0.2, "lepsza"),
      f("lokalizacja", 0.15, "lepsza"),
      f("pom_przynalezne", 0.1, "lepsza"),
    ],
    pdfSample: [
      ["2024-09", 64.9, 10015.41],
      ["2025-01", 64.9, 9399.08],
      ["2025-05", 64.9, 9630.2],
      ["2025-05", 56.2, 10498.22],
      ["2025-03", 64.9, 10246.53],
      ["2024-10", 55.8, 9498.21],
      ["2024-08", 56.1, 9893.05],
      ["2024-09", 56.5, 9203.54],
      ["2024-09", 67.5, 9629.63],
      ["2024-09", 55.3, 10036.17],
      ["2025-06", 63.06, 9673.33],
      ["2025-04", 65.2, 9815.95],
      ["2025-08", 64.9, 9244.99],
      ["2025-09", 63.5, 10078.74],
      ["2025-09", 64.9, 10292.76],
      ["2026-05", 64.9, 10169.49],
      ["2026-04", 56.2, 9964.41],
    ].map(([month, area, pricePerM2]) => ({
      month: month as string,
      area: area as number,
      pricePerM2: pricePerM2 as number,
