 ...
 *
 * Zakres na dzis: 36 wystapien, 20 unikalnych etykiet. To siec bezpieczenstwa
...
describe("etykiety przyciskow cytowane w Pomocy", () => {
  ...
  it("zna dokladny zakres: 36 wystapien, 20 unikalnych etykiet", () => {
