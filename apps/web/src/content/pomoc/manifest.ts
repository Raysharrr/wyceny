...
export const HELP_PAGES: HelpPage[] = [
  ...
  {
    slug: "rejestr-spoldzielczy",
    title: "Rejestr spółdzielczy",
    tree: "jak-korzystac",
    order: 10,
    tags: [
      "rejestr spółdzielczy",
    ...
    summary:
      "Własny rejestr transakcji spółdzielczych biura: import wykazu XLS z mapowaniem kolumn, ręczne dopisywanie, duplikaty i adresy „do poprawki”.",
