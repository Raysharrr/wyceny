...
| F-14 | Sample-selection fidelity — WR from the proposed RCN sample within ±10% (≥4) / ±5% (≥2) of six reference operaty, on frozen snapshots | `apps/web/tests/f14-sample-selection.test.ts`                                         |
